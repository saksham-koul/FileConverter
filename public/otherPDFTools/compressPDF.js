let convertButton = document.getElementById('compress_pdf_button')
convertButton.disabled = true
let fileInputButton = document.getElementById('fileInput_compress_pdf')
...
fileInputButton.addEventListener('change', e => {
    ...
    if (file !== undefined) {
        ...
        convertButton.onclick = async function () {
            ...
            convertButton.disabled = true
            await startConversion(file, 'pdf', 'compress', '', '', emailId)
            loading.style.display = 'none'
            fileInputButton.disabled = false
            convertButton.disabled = false
        }
